...
BEGIN_MESSAGE_MAP(CMFCappMVPApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMFCappMVPApp

CMFCappMVPApp::CMFCappMVPApp()
{
...
// Единственный объект CMFCappMVPApp

CMFCappMVPApp theApp;


// Инициализация CMFCappMVPApp

BOOL CMFCappMVPApp::InitInstance()
{
